...
public class SCENE2HeroMovement : MonoBehaviour {
	public Rigidbody rb;
	...
	public SCENE2RotationButton AmbilRotate;

	public SCENE2FadeStart AmbilFadeStart;

	public SCENE2Save save;
	...
	{
		positionX = save.getPositionX ();
		positionY = save.getPositionY ();
		positionZ = save.getPositionZ ();
	}
